...
public class Litedogespawn : MonoBehaviour
{
    public GameObject Litedoge;
    ...
    void Spawn()
    {
        ...
        GameObject newLitedoge = Instantiate(Litedoge, spawnPosition, Quaternion.identity);
        Destroy(newLitedoge, 10f);
    }
